...
class RelocManager(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            'reloc_manager started: 360deg odometry-based rotation, '
            'cov=1.0 (tolerates ~1.0m error), '
            'deceleration ramp enabled')
    ...
    def _enter_localizing(self):
        ...
        if self.swing_enabled:
            ...
            self.get_logger().info('swing disabled')
    ...
    def _amcl_pose_cb(self, msg: PoseWithCovarianceStamped):
        ...
        if cov_x < self.converged_xy_cov and cov_y < self.converged_xy_cov:
            ...
            self.get_logger().info(
                ...
                f'waiting for rotation to finish')
